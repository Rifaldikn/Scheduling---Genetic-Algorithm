      ...
      for (let j = 0; j < individu[0].length; j++) {
        for (let k = 0; k < 3; k++) {
          if (counter++ == rand) {
            ...
            // console.log("Individu before mutated", individu_mutated[i][j]);
            switch (k) {
              case 0:
                k = 3 // day
              ...
              case 2:
                ...
                var mutated_teachers = function (subjects_data, subject_id) {
                  ...
                  result = result[randomize(0, result.length - 1)]
                  return result
                };
            ...
            // console.log("Individu after mutated", individu_mutated[i][j]);
          }
        }
      }
    }
...
function parsingArr (arr) {
  // console.log(arr)
  // var parsedArr = new Array()
  var parsedArr = [[[[]]]]
  for (let h = 0; h < 5; h++) {
    parsedArr[h] = []
    for (let a = 0; a < 3; a++) {
      ...
      for (let j = 0; j < 3; j++) {
        ...
        for (let k = 0; k < 28; k++) {
          ...
          arr.forEach(gene => {
            ...
            switch (jurusan) {
              case 0:
                classIndex = angkatan * 8 + kelas
                break;
              case 1:
                classIndex = angkatan * 8 + ipa + kelas
                break;
              case 2:
                classIndex = angkatan * 8 + ipa + ips + kelas
                break;

              default:
                break
            }
            // console.log([classIndex, k]);
            if (
              angkatan == a &&
              jurusan == j &&
              classIndex - 1 == k &&
              ...
              // console.log([classIndex, k, a, j, k])
              parsedArr[h][a][j][k][start] = guru
              parsedArr[h][a][j][k][end] = guru

              // console.log("bitch", parsedArr[h][a][j][k], h, a, j, k, start);
            }
          })
        }
      }
  ...
  // console.log([hari, angkatan, jurusan, kelas, start, end, guru]);
